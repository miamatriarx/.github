...
✔️ If it's a relatively insignificant vulnerability you can create a new [issue](https://github.com/miamatriarx/.github/issues).\
✔️ If it's a critical vulnerability then don't create an issue or publicly expose it, doing so can potentially be harmful to users, directly [contact](https://github.com/miamatriarx/.github/blob/main/support.md) us instead.
